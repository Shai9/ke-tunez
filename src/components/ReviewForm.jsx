...
function ReviewForm ({review, handleFormBool, handleEditReview, handleCreateReview, song}) {
    ...
    const handleSubmit = (e, data, review, song) => {
        e.preventDefault()
        review ? handleEditReview(data, review.review, song) : handleCreateReview(data, song)
        handleFormBool()
    }

    return(
        <Box component="form" sx={{'& .MuiTextField-root': { m: 1, width: '25ch' },}}noValidateautoComplete="off" onChange={handleChange} onSubmit={(e) => handleSubmit(e, formData, review, song)}>
